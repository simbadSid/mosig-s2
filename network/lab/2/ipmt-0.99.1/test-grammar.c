...
#line 68 "test-grammar.y"
{
long int    a_val;
float       val_delay;
}
/* Line 193 of yacc.c.  */
#line 135 "test-grammar.c"
	YYSTYPE;
...
{
      11,     0,    -1,    12,     5,    -1,    11,    12,     5,    -1,
      17,    -1,    -1,    12,    13,    17,    -1,    15,    -1,    -1,
      12,    14,    15,    -1,     6,    16,    12,     7,    -1,    18,
       3,    -1,     8,    18,     3,     3,     9,    -1,     4,    -1,
       3,    -1
};
...
{
       0,   256,   257,   258,   259,    10,   123,   125,    91,    93
};
# endif
...
{
       0,     0,     0,     0,     5,     7,     4,    14,    13,     0,
       0,     0,     1,     5,     2,     0,     0,     5,    11,     0,
       3,     6,     9,    10,     0,    12
};
...
{
      12,    13,     1,     2,     2,    18,     1,    17,     2,     7,
       8,    19,    14,    -8,    20,    -8,    -8,    23,     1,    24,
      25,    22,    11,     0,     0,     0,     0,     0,    21
};
...
{
       0,     6,     8,    11,    12,    15,    17,     3,     4,    16,
      18,    18,     0,    12,     5,    13,    14,    12,     3,     3,
       5,    17,    15,     7,     3,     9
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 4:
#line 83 "test-grammar.y"
    {
                            }
    break;

  case 5:
#line 85 "test-grammar.y"
    {update_next(1);}
    break;

  case 6:
#line 86 "test-grammar.y"
    {    
                            }
    break;

  case 7:
#line 88 "test-grammar.y"
    {
                            }
    break;

  case 8:
#line 90 "test-grammar.y"
    {update_next(1);}
    break;

  case 9:
#line 91 "test-grammar.y"
    {
                            }
    break;

  case 10:
#line 94 "test-grammar.y"
    {   
  ...
  case 11:
#line 109 "test-grammar.y"
    {    // that's a repetition descriptor
                                atstdsc[curdsc].delay= (yyvsp[(1) - (2)].val_delay) ;
                                atstdsc[curdsc].nbr = (yyvsp[(2) - (2)].a_val) ; 
  ...
  case 12:
#line 121 "test-grammar.y"
    {
                                atstdsc[curdsc].delay= (yyvsp[(2) - (5)].val_delay) ;
                                atstdsc[curdsc].nbr = (yyvsp[(3) - (5)].a_val) ; 
                                atstdsc[curdsc].sz= (yyvsp[(4) - (5)].a_val);
  ...
  case 13:
#line 131 "test-grammar.y"
    {
                            }
    break;

  case 14:
#line 133 "test-grammar.y"
    {
                                (yyval.val_delay) = (float) (yyvsp[(1) - (1)].a_val) ;
                            }
    break;


/* Line 1267 of yacc.c.  */
#line 1437 "test-grammar.c"
      default: break;
    }
